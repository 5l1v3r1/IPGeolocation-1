...
"""
    ...
    Copyright (C) 2015-2016 MRLINKERRORSYSTEM@Progammer.net
    https://github.com/Ahmadchen/IPGeoLocation
...
__author__   = 'Mrlinkerrorsystem'
__email__  = 'MRLINKERRORSYSTEM@Progammer.net'
__version__  = '2.0.4'
__year__     = '2015-2019'
